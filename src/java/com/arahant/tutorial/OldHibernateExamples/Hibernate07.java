...
public class Hibernate07 {
	...
	public static void main (final String args[])
	{
		...
		try
		{	
			//This is how you filter down to just one field
			final List  cc=hsu.createCriteria(Employee.class).selectFields(Person.LNAME).list();

			final Iterator citr=cc.iterator();
			while (citr.hasNext())
