...
-- PostgreSQL patch from revision 583 to revision 584
...
ALTER TABLE "client_contact" ADD COLUMN "email_invoice" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "company_detail" ADD COLUMN "email_out_type" smallint DEFAULT 0 NOT NULL;

ALTER TABLE "company_detail" ADD COLUMN "email_out_authentication" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "company_detail" ADD COLUMN "email_out_host" character varying(30);

ALTER TABLE "company_detail" ADD COLUMN "email_out_domain" character varying(40);

ALTER TABLE "company_detail" ADD COLUMN "email_out_port" integer DEFAULT 25 NOT NULL;

ALTER TABLE "company_detail" ADD COLUMN "email_out_encryption" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "company_detail" ADD COLUMN "email_out_user_id" character varying(50);

ALTER TABLE "company_detail" ADD COLUMN "email_out_user_pw" character varying(30);

ALTER TABLE "company_detail" ADD COLUMN "email_out_from_name" character varying(50);

ALTER TABLE "company_detail" ADD COLUMN "email_out_from_email" character varying(50);
...
ALTER TABLE "client_contact" ADD CONSTRAINT "client_contact_email_chk" CHECK (((email_invoice='Y')OR(email_invoice='N')));

ALTER TABLE "company_detail" ADD CONSTRAINT "compdet_eo_auth_chk" CHECK (((email_out_authentication='N')OR(email_out_authentication='P')));

ALTER TABLE "company_detail" ADD CONSTRAINT "compdet_eo_encrypt_chk" CHECK ((((email_out_encryption='N')OR(email_out_encryption='S'))OR(email_out_encryption='T')));

ALTER TABLE "company_detail" ADD CONSTRAINT "compdet_eo_type_chk" CHECK ((((email_out_type=0)OR(email_out_type=1))OR(email_out_type=2)));
