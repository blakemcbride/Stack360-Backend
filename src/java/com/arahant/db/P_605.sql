...
-- PostgreSQL patch from revision 604 to revision 605
...
ALTER TABLE "wizard_configuration" ADD COLUMN "show_qualifying_event" character(1) DEFAULT 'Y' NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "allow_demographic_changes" character(1) DEFAULT 'Y' NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "hde_type" smallint DEFAULT 1 NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "hde_period" smallint DEFAULT 0 NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "hde_days_before" smallint DEFAULT 0 NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "hde_days_after" smallint DEFAULT 30 NOT NULL;
...
ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_conf_adc_chk" CHECK (((allow_demographic_changes='Y')OR(allow_demographic_changes='N')));

ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_conf_hde_type_chk" CHECK (((hde_type>=1)AND(hde_type<=5)));

ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_conf_sqe_chk" CHECK (((show_qualifying_event='Y')OR(show_qualifying_event='N')));
