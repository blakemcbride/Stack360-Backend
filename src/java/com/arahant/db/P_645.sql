...
-- PostgreSQL patch from revision 644 to revision 645
...
ALTER TABLE "wizard_config_benefit" ADD COLUMN "decline_message" character varying(1200);
...
ALTER TABLE "wizard_configuration" DROP COLUMN "decline_message";
