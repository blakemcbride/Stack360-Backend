...
-- PostgreSQL patch from revision 499 to revision 501
...
ALTER TABLE "org_group" ADD COLUMN "timesheet_period_type" character(1) DEFAULT 'I' NOT NULL;

ALTER TABLE "org_group" ADD COLUMN "timesheet_period_start_date" integer DEFAULT 0 NOT NULL;

ALTER TABLE "org_group" ADD COLUMN "timesheet_show_billable" character(1) DEFAULT 'I' NOT NULL;
...
ALTER TABLE "org_group" ADD CONSTRAINT "org_group_period_type_chk" CHECK (((((((timesheet_period_type='I')OR(timesheet_period_type='D'))OR(timesheet_period_type='W'))OR(timesheet_period_type='B'))OR(timesheet_period_type='S'))OR(timesheet_period_type='M')));

ALTER TABLE "org_group" ADD CONSTRAINT "org_group_show_bill_chk" CHECK ((((timesheet_show_billable='I')OR(timesheet_show_billable='Y'))OR(timesheet_show_billable='N')));
