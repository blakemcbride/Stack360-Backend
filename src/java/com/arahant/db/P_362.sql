...
-- PostgreSQL patch from revision 361 to revision 362
...
ALTER TABLE "benefit_config_cost" ADD COLUMN "guaranteed_issue_type" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "guaranteed_issue_amount" double precision DEFAULT 0 NOT NULL;


--  Change existing columns

DROP INDEX "fki_invoice_company_fkey";

ALTER TABLE "invoice" ALTER COLUMN "customer_id" SET NOT NULL;
...
ALTER TABLE "benefit_config_cost" ADD CONSTRAINT "benefit_confcost_gi_typ_chk" CHECK ((((guaranteed_issue_type='N')OR(guaranteed_issue_type='M'))OR(guaranteed_issue_type='F')));
