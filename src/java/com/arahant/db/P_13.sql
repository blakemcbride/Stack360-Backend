...
DROP INDEX "org_group_guid_idx";

DROP INDEX "person_person_guid_idx";
...
ALTER TABLE "hr_employee_beneficiary" ALTER COLUMN "ssn" TYPE character varying(32);
ALTER TABLE "hr_employee_beneficiary_h" ALTER COLUMN "ssn" TYPE character varying(32);
ALTER TABLE "person" ALTER COLUMN "ssn" TYPE character varying(32);
ALTER TABLE "person_h" ALTER COLUMN "ssn" TYPE character varying(32);
