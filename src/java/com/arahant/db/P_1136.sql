...
-- PostgreSQL patch from revision 1135 to revision 1136
...
ALTER TABLE "employee_rate" DROP CONSTRAINT "emp_rate_ratetyp_fkey";
...
ALTER TABLE "employee_rate" DROP CONSTRAINT "employee_rate_person_fkey";

ALTER TABLE "expense" DROP CONSTRAINT "expense_auth_employee_fki";

ALTER TABLE "expense" DROP CONSTRAINT "expense_employee_fki";

ALTER TABLE "expense" DROP CONSTRAINT "expense_project_fki";
...
ALTER TABLE "project" DROP CONSTRAINT "project_rate_type_fkey";
...
ALTER TABLE "rate_type" DROP CONSTRAINT "rate_type_company_fkey";
...
ALTER TABLE "expense" ADD COLUMN "auth_person_id" character(16) NOT NULL;
...
ALTER TABLE "expense" DROP COLUMN "auth_employee_id";


--  Add new indexes and checks

CREATE INDEX "expense_apers_idx" ON "expense" USING btree ("auth_person_id");

COMMENT ON COLUMN "expense"."auth_person_id" IS 'Person who added the record';
...
ALTER TABLE ONLY "employee_rate" ADD CONSTRAINT "emp_rate_ratetyp_fkey" FOREIGN KEY ("rate_type_id") REFERENCES "rate_type" ("rate_type_id");
...
ALTER TABLE ONLY "employee_rate" ADD CONSTRAINT "employee_rate_person_fkey" FOREIGN KEY ("person_id") REFERENCES "employee" ("person_id");

ALTER TABLE ONLY "expense" ADD CONSTRAINT "expense_auth_person_fk" FOREIGN KEY ("auth_person_id") REFERENCES "person" ("person_id");

ALTER TABLE ONLY "expense" ADD CONSTRAINT "expense_employee_fki" FOREIGN KEY ("employee_id") REFERENCES "employee" ("person_id");

ALTER TABLE ONLY "expense" ADD CONSTRAINT "expense_project_fki" FOREIGN KEY ("project_id") REFERENCES "project" ("project_id");
...
ALTER TABLE ONLY "project" ADD CONSTRAINT "project_rate_type_fkey" FOREIGN KEY ("rate_type_id") REFERENCES "rate_type" ("rate_type_id");
...
ALTER TABLE ONLY "rate_type" ADD CONSTRAINT "rate_type_company_fkey" FOREIGN KEY ("company_id") REFERENCES "company_detail" ("org_group_id");
