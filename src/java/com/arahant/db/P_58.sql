...
-- PostgreSQL patch from revision 56 to revision 58
...
ALTER TABLE "wizard_configuration" ADD COLUMN "welcome_avatar" character varying(256);

ALTER TABLE "wizard_configuration" ADD COLUMN "qualifying_event_avatar" character varying(256);

ALTER TABLE "wizard_configuration" ADD COLUMN "demographics_avatar" character varying(256);

ALTER TABLE "wizard_configuration" ADD COLUMN "dependents_avatar" character varying(256);

ALTER TABLE "wizard_configuration" ADD COLUMN "review_avatar" character varying(256);

ALTER TABLE "wizard_configuration" ADD COLUMN "finish_avatar" character varying(256);

ALTER TABLE "wizard_configuration" ADD COLUMN "enable_avatars" character(1) DEFAULT 'Y' NOT NULL;
...
ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_config_enable_avatar_chk" CHECK (((enable_avatars='Y')OR(enable_avatars='N')));
