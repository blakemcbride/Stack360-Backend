...
-- PostgreSQL patch from revision 629 to revision 630
...
ALTER TABLE "wizard_configuration" ADD COLUMN "decline_message" character varying(1200);
...
COMMENT ON COLUMN "wizard_configuration"."decline_message" IS 'Message shown when user declines a benefit.  This overrides a default message.';
