...
-- PostgreSQL patch from revision 459 to revision 460
...
ALTER TABLE "company_detail" ADD COLUMN "fiscal_beginning_month" smallint DEFAULT 1 NOT NULL;

ALTER TABLE "time_off_accrual_calc" ADD COLUMN "period_start_date" integer DEFAULT 0 NOT NULL;
...
ALTER TABLE "time_off_accrual_calc" DROP CONSTRAINT "timeoff_acccalc_period_chk";


--  Add new indexes and checks

ALTER TABLE "company_detail" ADD CONSTRAINT "company_detail_fiscal_begmon_chk" CHECK (((fiscal_beginning_month>=1)AND(fiscal_beginning_month<=12)));

ALTER TABLE "time_off_accrual_calc" ADD CONSTRAINT "time_off_acccalc_pstart_chk" CHECK (((((period_start='C')OR(period_start='H'))OR(period_start='F'))OR(period_start='S')));

ALTER TABLE "time_off_accrual_calc" ADD CONSTRAINT "timeoff_acccalc_perdate" CHECK (((period_start_date>=0)AND(period_start_date<=1231)));
