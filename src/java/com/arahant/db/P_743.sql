...
-- PostgreSQL patch from revision 742 to revision 743
...
ALTER TABLE "project" ALTER COLUMN "reference" TYPE character varying(20);
...
CREATE INDEX "project_reference_idx" ON "project" USING btree (lower("reference"));
