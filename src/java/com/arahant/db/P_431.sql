...
-- PostgreSQL patch from revision 430 to revision 431
...
ALTER TABLE "client" ADD COLUMN "payment_terms" smallint DEFAULT 0 NOT NULL;

ALTER TABLE "employee" ADD COLUMN "employment_type" character(1) DEFAULT 'E' NOT NULL;

ALTER TABLE "invoice" ADD COLUMN "purchase_order" character varying(15);

ALTER TABLE "invoice" ADD COLUMN "payment_terms" smallint DEFAULT 0 NOT NULL;

ALTER TABLE "project" ADD COLUMN "purchase_order" character varying(15);
...
ALTER TABLE "employee" ADD CONSTRAINT "employee_etype_chk" CHECK (((employment_type='E')OR(employment_type='C')));
