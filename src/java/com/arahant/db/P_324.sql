...
-- PostgreSQL patch from revision 173 to revision 324
...
ALTER TABLE "benefit_config_cost" ADD COLUMN "fixed_employee_cost" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "fixed_employer_cost" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "benefit_amount" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "min_value" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "max_value" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "step_value" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "max_multiple_of_salary" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "rate_per_unit" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "rate_frequency" smallint DEFAULT 12 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "rate_relates_to" character(1) DEFAULT 'B' NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "salary_round_type" character(1) DEFAULT 'D' NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "salary_round_amount" double precision DEFAULT 1 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "benefit_round_type" character(1) DEFAULT 'D' NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "benefit_round_amount" double precision DEFAULT 1 NOT NULL;

ALTER TABLE "benefit_config_cost" ADD COLUMN "cap_type" character(1) DEFAULT 'L' NOT NULL;

ALTER TABLE "benefit_config_cost_age" ADD COLUMN "ee_value" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost_age" ADD COLUMN "er_value" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "benefit_config_cost_age" ADD COLUMN "insurance_id" character varying(15);

ALTER TABLE "employee" ADD COLUMN "hours_per_week" smallint DEFAULT 0 NOT NULL;

ALTER TABLE "hr_benefit" ADD COLUMN "employer_cost_model" character(1) DEFAULT 'Z' NOT NULL;

ALTER TABLE "hr_benefit" ADD COLUMN "employee_cost_model" character(1) DEFAULT 'Z' NOT NULL;

ALTER TABLE "hr_benefit" ADD COLUMN "benefit_amount_model" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "hr_benefit" ADD COLUMN "min_pay" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "hr_benefit" ADD COLUMN "max_pay" double precision DEFAULT 0 NOT NULL;

ALTER TABLE "hr_benefit" ADD COLUMN "min_hours_per_week" real DEFAULT 0 NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "show_annual_cost" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "show_monthly_cost" character(1) DEFAULT 'N' NOT NULL;

ALTER TABLE "wizard_configuration" ADD COLUMN "show_ppp_cost" character(1) DEFAULT 'Y' NOT NULL;

--  Custom stuff


ALTER TABLE "project" ADD COLUMN "company_id" character(16) NOT NULL DEFAULT '0';

update project set company_id = (select org_group_id from company_detail limit 1);
...
ALTER TABLE "benefit_config_cost" DROP CONSTRAINT "benefit_concost_base_src_chk";

ALTER TABLE "benefit_config_cost" DROP COLUMN "base_amount_source";

ALTER TABLE "benefit_config_cost" DROP COLUMN "base_amount";

ALTER TABLE "benefit_config_cost" DROP COLUMN "base_round_amount";

ALTER TABLE "benefit_config_cost" DROP COLUMN "base_cap_amount";

ALTER TABLE "benefit_config_cost" DROP CONSTRAINT "benefit_concost_mult_src_chk";

ALTER TABLE "benefit_config_cost" DROP COLUMN "multiplier_source";

ALTER TABLE "benefit_config_cost" DROP COLUMN "formula_multiplier";

ALTER TABLE "benefit_config_cost" DROP COLUMN "formula_divider";

ALTER TABLE "benefit_config_cost" DROP CONSTRAINT "benefit_config_cost_enrchk";

ALTER TABLE "benefit_config_cost" DROP COLUMN "cost_per_enrollee";

ALTER TABLE "benefit_config_cost_age" DROP COLUMN "multiplier";

ALTER TABLE "hr_benefit" DROP CONSTRAINT "hr_benefit_empl_provider_chk";

ALTER TABLE "hr_benefit" DROP COLUMN "employee_specific_cost";

ALTER TABLE "hr_benefit" DROP CONSTRAINT "hr_benefit_emp_chose_amt_chk";

ALTER TABLE "hr_benefit" DROP COLUMN "employee_chooses_amount";

ALTER TABLE "hr_benefit_config" DROP COLUMN "employee_cost";

ALTER TABLE "hr_benefit_config" DROP COLUMN "employer_cost";

ALTER TABLE "hr_benefit_config" DROP COLUMN "max_value";

ALTER TABLE "hr_benefit_config" DROP COLUMN "min_value";

ALTER TABLE "hr_benefit_config" DROP COLUMN "step_value";


--  Add new indexes and checks

ALTER TABLE "benefit_config_cost" ADD CONSTRAINT "benefit_config_cost_rt_chk" CHECK (((rate_relates_to='B')OR(rate_relates_to='S')));

ALTER TABLE "benefit_config_cost" ADD CONSTRAINT "benefit_config_cost_srt_chk" CHECK ((((salary_round_type='N')OR(salary_round_type='U'))OR(salary_round_type='D')));

ALTER TABLE "benefit_config_cost" ADD CONSTRAINT "benefit_cost_config_brt_chk" CHECK ((((benefit_round_type='N')OR(benefit_round_type='U'))OR(benefit_round_type='D')));

ALTER TABLE "hr_benefit" ADD CONSTRAINT "hr_benefit_coverage_model_chk" CHECK ((((((benefit_amount_model='N')OR(benefit_amount_model='F'))OR(benefit_amount_model='R'))OR(benefit_amount_model='S'))OR(benefit_amount_model='M')));

ALTER TABLE "hr_benefit" ADD CONSTRAINT "hr_benefit_employee_model_chk" CHECK ((((((employee_cost_model='Z')OR(employee_cost_model='F'))OR(employee_cost_model='A'))OR(employee_cost_model='R'))OR(employee_cost_model='B')));

ALTER TABLE "hr_benefit" ADD CONSTRAINT "hr_benefit_employer_model_chk" CHECK (((((employer_cost_model='Z')OR(employer_cost_model='F'))OR(employer_cost_model='A'))OR(employer_cost_model='B')));

ALTER TABLE "hr_benefit" DROP CONSTRAINT "hr_benefit_pre_tax_chk";

ALTER TABLE "hr_benefit" ADD CONSTRAINT "hr_benefit_pre_tax_chk" CHECK ((((pre_tax='Y')OR(pre_tax='N'))OR(pre_tax='E')));

ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_config_show_ann_chk" CHECK (((show_annual_cost='Y')OR(show_annual_cost='N')));

ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_config_show_mothly_chk" CHECK (((show_monthly_cost='Y')OR(show_monthly_cost='N')));

ALTER TABLE "wizard_configuration" ADD CONSTRAINT "wizard_config_show_ppp_chk" CHECK (((show_ppp_cost='Y')OR(show_ppp_cost='N')));
