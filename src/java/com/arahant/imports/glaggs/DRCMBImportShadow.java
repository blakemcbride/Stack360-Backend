 ...
 *
 */
public class DRCMBImportShadow extends GLAGSFixedImportBase{
	...
	public static void main (String args[])
	{
		try {
			...
			DRCMBImportShadow x = new DRCMBImportShadow();
		...
		//	ArahantSession.getHSU().rollbackTransaction();
			...
			ArahantSession.getHSU().rollbackTransaction();
			Logger.getLogger(DRCMBImportShadow.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
