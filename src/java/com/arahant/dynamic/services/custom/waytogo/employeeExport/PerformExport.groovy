...
package com.arahant.dynamic.services.custom.waytogo.employeeExport
...
//		String file = new NorthAmericaAdministratorsExport().export()			
		GroovyClass gc = new GroovyClass(true, "com/arahant/groovy/exports/WayToGoEmployeeExport.groovy")
