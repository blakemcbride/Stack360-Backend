...
/*
*/
package com.arahant.dynamic.services.standard.time.approvedTimeOffRequestReport;

import com.arahant.reports.TimeOffRequestApprovedReport;
...
public class GetReport {
	...
	public static void main(DataObjectMap in, DataObjectMap out, HibernateSessionUtil hsu, DynamicWebServiceOps service) {
		try {
			out.put("reportUrl", new TimeOffRequestApprovedReport().build(in.getInt("beginningDate"), in.getInt("endingDate")));
		} catch (Exception ex) {
