...
class PerDiemExport {
    ...
    {
        int begDate = input.getInt("begPDPeriod")
        int endDate = input.getInt("endPDPeriod")
...
//		String file = new NorthAmericaAdministratorsExport().export()
        GroovyClass gc = new GroovyClass(true, "com/arahant/groovy/exports/PaychexPerDiemExport.groovy")
