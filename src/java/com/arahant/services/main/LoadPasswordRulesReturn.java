...
public class LoadPasswordRulesReturn extends TransmitReturnBase {
    ...
    private int minimumLength = BProperty.getInt(StandardProperty.PasswordMinimumLength);
    private int minimumLetters = BProperty.getInt(StandardProperty.PasswordMinimumLetters);
    private int minimumUpperCaseLetters = BProperty.getInt(StandardProperty.PasswordMinimumUpperCase);
    private int minimumLowerCaseLetters = BProperty.getInt(StandardProperty.PasswordMinimumLowerCase);
    private int minimumDigits = BProperty.getInt(StandardProperty.PasswordMinimumDigits);
    private int minimumSpecialChars = BProperty.getInt(StandardProperty.PasswordMinimumSpecialChars);
