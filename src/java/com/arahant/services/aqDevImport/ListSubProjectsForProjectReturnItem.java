 ...
 *
 */
public class ListSubProjectsForProjectReturnItem {
	
	public ListSubProjectsForProjectReturnItem()
	{
		;
	}

	ListSubProjectsForProjectReturnItem (BProject bc)
	{
		...
		requestingNameFormatted=bc.getRequestingNameFormatted();
