 ...
 *
 */
public class NewProjectCategoryReturn extends TransmitReturnBase  {

	public NewProjectCategoryReturn() {
		super();
	}
		 ...
		 * @param category
		 */
		public NewProjectCategoryReturn(final ProjectCategory category) {
