 ...
 * Arahant
 */
public interface IDynamicWebServiceValidation {
	public static final String VALIDATION_STRING = "_validation";
	public DataObject getAllValidations(DataObject in);
	public DataObject getMethodValidation (String methodName);
