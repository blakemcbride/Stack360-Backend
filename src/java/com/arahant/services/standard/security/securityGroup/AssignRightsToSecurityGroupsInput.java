 ...
 */
public class AssignRightsToSecurityGroupsInput extends TransmitInputBase {
	@Validation (required=false)
	private String groupIds [];
	@Validation (required=false)
	private String tokenIds [];
	@Validation (min=0,max=3,required=false)
	private int tokenAccessLevel;// 1 = None  2 = Read  3 = Write 
	 ...
	 */
	public int getTokenAccessLevel() {
		return tokenAccessLevel;
	}
	/**
	 * @param tokenAccessLevel The tokenAccessLevel to set.
	 */
	public void setTokenAccessLevel(final int tokenAccessLevel) {
