...
public class ListAssociatedSecurityGroupsReturn extends TransmitReturnBase {
	...
	void setSecurityGroups(final BSecurityGroup[] a) {
		securityGroups=new SecurityGroup[a.length];
		for (int loop=0;loop<a.length;loop++)
			securityGroups[loop]=new SecurityGroup(a[loop]);
	}
}
