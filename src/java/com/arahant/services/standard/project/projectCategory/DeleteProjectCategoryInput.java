 ...
 *
 */
public class DeleteProjectCategoryInput extends TransmitInputBase {


@Validation (required=false)
	private String projectCategoryIds[];
	public DeleteProjectCategoryInput() {
		super();
	}
	/**
	 ...
	 */
	public void setProjectCategoryIds(final String []projectCategoryIds) {
