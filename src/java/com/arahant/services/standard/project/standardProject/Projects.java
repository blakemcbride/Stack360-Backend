...
public class Projects {
	 ...
	 * @param project
	 */
	Projects(final BStandardProject p) {
		super();
		
		 accessibleToAll=p.getAllEmployees()+"";
	 ...
	 */
	public String getAccessibleToAll() {
	 ...
	 */
	public void setAccessibleToAll(final String accessibleToAll) {
