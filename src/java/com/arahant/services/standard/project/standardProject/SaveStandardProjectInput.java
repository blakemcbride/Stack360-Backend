 ...
 *
 */
public class SaveStandardProjectInput extends TransmitInputBase {

	@Validation (table="standard_project",column="reference",required=true)
	...
	public SaveStandardProjectInput() {
		super();
	}
