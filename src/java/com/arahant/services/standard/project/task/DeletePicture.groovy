...
class DeletePicture {
    ...
    static void main(JSONObject injson, JSONObject outjson, HibernateSessionUtil hsu, REST service) {
        ...
        ExternalFile.deleteAllExternalFiles("project_task_picture", projectTaskPictureId)
        db.execute("delete from project_task_picture where project_task_picture_id = ?", projectTaskPictureId)
    }
}
