...
public class CheckRightReturn extends TransmitReturnBase {
	...
	private boolean projectIdManualEntry;
	...
	public boolean getProjectIdManualEntry() {
		return projectIdManualEntry;
	}

	public void setProjectIdManualEntry(boolean projectIdManualEntry) {
		this.projectIdManualEntry = projectIdManualEntry;
	}
