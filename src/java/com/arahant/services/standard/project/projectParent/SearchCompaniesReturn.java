...
public class SearchCompaniesReturn extends TransmitReturnBase {
	...
	private SearchCompaniesReturnItem selectedItem;
	...
	public SearchCompaniesReturnItem getSelectedItem() {
		return selectedItem;
	}

	public void setSelectedItem(final SearchCompaniesReturnItem selectedItem) {
