 ...
 *
 */
public class ListAvailableBenefitConfigsReturnItem {
	
	public ListAvailableBenefitConfigsReturnItem()
	{
		;
	}

	ListAvailableBenefitConfigsReturnItem (BHRBenefitConfig bc)
	{
