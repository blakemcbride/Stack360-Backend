...
public class SearchAssignablePersonsForProjectReturn extends TransmitReturnBase {
	SearchAssignablePersonsForProjectReturnItem item[];
	...
	void setItem(final BPerson[] a) {
		item=new SearchAssignablePersonsForProjectReturnItem[a.length];
		for (int loop=0;loop<a.length;loop++)
			item[loop]=new SearchAssignablePersonsForProjectReturnItem(a[loop]);
	}
}
