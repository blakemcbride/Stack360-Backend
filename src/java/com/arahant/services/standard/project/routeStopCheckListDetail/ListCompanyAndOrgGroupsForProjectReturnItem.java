 ...
 *
 */
public class ListCompanyAndOrgGroupsForProjectReturnItem {
	
	public ListCompanyAndOrgGroupsForProjectReturnItem()
	{
		;
	}

	ListCompanyAndOrgGroupsForProjectReturnItem (BOrgGroup bc)
	{
