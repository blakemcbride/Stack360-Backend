 ...
 *
 */
public class DissassociateSubProjectsFromParentProjectInput extends TransmitInputBase {
...
;
	...
	public String [] getSubProjectIds()
	{
		if (subProjectIds==null)
			subProjectIds= new String [0];
		return subProjectIds;
	}
	public void setSubProjectIds(String [] subProjectIds)
	{
