 ...
 *
 */
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardProjectProjectTimesheetReportClientOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class ProjectTimesheetReportClientOps extends ServiceBase {
	
	private static final ArahantLogger logger = new ArahantLogger(ProjectTimesheetReportClientOps.class);
