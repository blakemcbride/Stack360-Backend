 ...
 *
 */
public class SaveProjectRouteInput extends TransmitInputBase {

	@Validation (required=false)
	private SaveProjectRouteInputItem item[];
	
	/**
	 * @return Returns the item.
	 */
	public SaveProjectRouteInputItem[] getItem() {
            if (item==null)
                return new SaveProjectRouteInputItem[0];
		return item;
	}
	/**
	 * @param item The item to set.
	 */
	public void setItem(final SaveProjectRouteInputItem[] item) {
		this.item = item;
	}
