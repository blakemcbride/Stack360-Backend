 ...
 *
 */
public class NewProjectTypeReturn extends TransmitReturnBase {
	...
	public NewProjectTypeReturn()
	{
		;
	}
	public NewProjectTypeReturn(final ProjectType pt)
	{
	...
	/* (non-Javadoc)
	 * @see com.arahant.operations.transmit.IProjectTypeTransmit#makeProjectType(com.arahant.beans.ProjectType)
	 */
	public ProjectType makeProjectType(final ProjectType pt)
	{
		pt.setCode(code);
		pt.setDescription(description);
		pt.setProjectTypeId(projectTypeId);
		return pt;
	}
