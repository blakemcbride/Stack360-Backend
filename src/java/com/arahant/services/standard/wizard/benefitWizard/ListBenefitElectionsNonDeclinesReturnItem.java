...
public class ListBenefitElectionsNonDeclinesReturnItem {
	...
	public ListBenefitElectionsNonDeclinesReturnItem() {
	}

	ListBenefitElectionsNonDeclinesReturnItem(BHRBenefitJoin bj) {
