...
public class ListDependentsAndEmployeeSimpleReturnItem {
	...
	public ListDependentsAndEmployeeSimpleReturnItem()
	{
	}

	ListDependentsAndEmployeeSimpleReturnItem(HrEmplDependentWizard ew, String benefitId, String categoryId)
	{
	...
	ListDependentsAndEmployeeSimpleReturnItem(BPerson bpp, BEmployee be, String benefitId, String categoryId)
	{
