...
public class ListEnrolleesReturnItem {

	private String personId;
	private String benefitJoinId;
	private String coveredPerson;

	public ListEnrolleesReturnItem() {
	}

	ListEnrolleesReturnItem(BHRBenefitJoin bc) {
		personId = bc.getCoveredPersonId();
		benefitJoinId = bc.getBenefitJoinId();
		coveredPerson = bc.getCoveredNameLFM();
	}
