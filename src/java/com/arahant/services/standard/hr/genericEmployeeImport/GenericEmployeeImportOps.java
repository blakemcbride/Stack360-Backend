...
/*
 */
package com.arahant.services.standard.hr.genericEmployeeImport;
...
@WebService(targetNamespace = "http://operations.arahant.com", serviceName = "StandardHrGenericEmployeeImportOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED)
@ThreadScope()
public class GenericEmployeeImportOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(GenericEmployeeImportOps.class);

	public GenericEmployeeImportOps() {}
