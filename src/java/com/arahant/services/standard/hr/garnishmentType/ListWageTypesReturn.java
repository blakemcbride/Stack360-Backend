...
public class ListWageTypesReturn extends TransmitReturnBase {
	private ListWageTypesReturnItem item[];
	private ListWageTypesReturnItem selectedItem;
	...
	public ListWageTypesReturnItem getSelectedItem() {
		return selectedItem;
	}

	public void setSelectedItem(final ListWageTypesReturnItem selectedItem) {
