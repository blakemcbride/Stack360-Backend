 ...
 *
 */
public class SearchNoCompanyScreenGroupsReturnItem  {
	...
	public SearchNoCompanyScreenGroupsReturnItem() {

	}

	SearchNoCompanyScreenGroupsReturnItem(final BScreenOrGroup sg) {
