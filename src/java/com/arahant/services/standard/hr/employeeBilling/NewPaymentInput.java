 ...
 *
 */
public class NewPaymentInput extends TransmitInputBase {

	void setData(BReceipt bc)
	{
		getItem(); //check for null
	...
	private NewPaymentInputItem []item;
	...
	public NewPaymentInputItem[] getItem() {
		if (item==null)
			item=new NewPaymentInputItem[0];
		return item;
	}

	public void setItem(NewPaymentInputItem[] item) {
		this.item = item;
	}
