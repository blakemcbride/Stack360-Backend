...
public class SearchGLAccountsInput extends TransmitInputBase {
	...
	@Validation (required=false)
	private String selectFromInvoiceId;
	@Validation (required=false)
	private boolean selectFromCompanyDefault;
	...
	public String getSelectFromInvoiceId()
	{
		return selectFromInvoiceId;
	}
	public void setSelectFromInvoiceId(String selectFromInvoiceId)
	{
		this.selectFromInvoiceId=selectFromInvoiceId;
	}
	public boolean getSelectFromCompanyDefault()
	{
		return selectFromCompanyDefault;
	}
	public void setSelectFromCompanyDefault(boolean selectFromCompanyDefault)
	{
		this.selectFromCompanyDefault=selectFromCompanyDefault;
	}
