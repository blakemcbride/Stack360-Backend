...
public class NewBenefitInput extends TransmitInputBase {
    ...
    void setData(final BHRBenefit bc) {
		...
		bc.setAdditionalInstructions(instructions);
    ...
    public void setContingentBeneficiaries(boolean contingnetBeneficiaries) {
        this.contingentBeneficiaries = contingnetBeneficiaries;
    }
    ...
    public boolean isIncludeInOpenEnrollment() {
