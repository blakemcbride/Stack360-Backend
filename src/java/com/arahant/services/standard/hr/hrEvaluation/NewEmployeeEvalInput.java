 ...
 *
 */
public class NewEmployeeEvalInput extends TransmitInputBase {


	public NewEmployeeEvalInput() {
		super();
	}
	...
	@Validation (table="hr_employee_eval",column="comments",required=false)
	private String supervisorComments;
	
	@Validation (table="hr_employee_eval",column="p_comments",required=false)
