 ...
 *
 */
public class LoadEvalDescriptionInput extends TransmitInputBase {
	 ...
	 */
	public void setEvalCatId(final String evalId) {
		this.evalCatId = evalId;
	}
	public LoadEvalDescriptionInput() {
		super();
	}
}
