...
public class SaveConfigInputCost {
	...
	private SaveConfigInputCostAge[] age;

	public SaveConfigInputCost() {
	}
	...
	public void setData(BBenefitConfigCost bcc) {
		...
		for (SaveConfigInputCostAge a : getAge()) {
	...
	public SaveConfigInputCostAge[] getAge() {
		if (age == null)
			age = new SaveConfigInputCostAge[0];
		return age;
	}

	public void setAge(SaveConfigInputCostAge[] age) {
		this.age = age;
	}
