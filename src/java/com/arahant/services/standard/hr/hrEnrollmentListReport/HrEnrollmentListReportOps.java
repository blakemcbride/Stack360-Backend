...
import com.arahant.reports.EmployeeEnrollmentReport;
 ...
 *
 */
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardHrHrEnrollmentListReportOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class HrEnrollmentListReportOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(
			HrEnrollmentListReportOps.class);
	
	public HrEnrollmentListReportOps() {
		super();
	}
...
//				.getReport(in.getBenefitId(),
//					in.getOrgGroupId(),
//					in.getStatusId(),
//					in.getEnrolledAsOf()));
                          
                        ret.setReportUrl(new EmployeeEnrollmentReport().build(in.getBenefitCategoryId(),
                                in.getBenefitId(),
				in.getStatusId(),
                                in.getOrgGroupId(),
				in.getEnrolledAsOf()));
