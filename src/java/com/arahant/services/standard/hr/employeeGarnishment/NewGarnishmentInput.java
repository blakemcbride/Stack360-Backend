 ...
 *
 */
public class NewGarnishmentInput extends TransmitInputBase {
	...
	@Validation (table="garnishment",column="person_id",required=true)
	...
	@Validation (table="garnishment",column="garnishment_id",required=false)
