...
public class ListRouteStopsForProjectReturn extends TransmitReturnBase {
	private ListRouteStopsForProjectReturnItem item[];
	private String currentRouteStopId;
	private String currentAssignedPersonId;

	public String getCurrentAssignedPersonId() {
		return currentAssignedPersonId;
	}

	public void setCurrentAssignedPersonId(String currentAssignedPersonId) {
		this.currentAssignedPersonId = currentAssignedPersonId;
	}
