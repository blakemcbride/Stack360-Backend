 ...
 *
 */
public class LoadProposedDetailReturnBeneficiariesItem {
	...
	public LoadProposedDetailReturnBeneficiariesItem()
	{
	}

	LoadProposedDetailReturnBeneficiariesItem (final BHRBeneficiary bc)
	{
