...
class ListProjectCategories {
    ...
    static void main(JSONObject injson, JSONObject outjson, HibernateSessionUtil hsu, REST service) {
        ...
        List<Record> recs = db.fetchAll("""
            select project_category_id, code, description, scope, last_active_date
        ...
        for (Record rec : recs) {
            ...
            obj.put('projectCategoryId', rec.getString('project_category_id'))
