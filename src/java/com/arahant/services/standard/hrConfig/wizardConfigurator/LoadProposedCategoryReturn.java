...
public class LoadProposedCategoryReturn extends TransmitReturnBase {
	...
	public void setData(final String catId)
	{
		BHRBenefitCategory c = new BHRBenefitCategory(catId);
		allowsMultipleBenefits = c.getAllowsMultipleBenefits();
