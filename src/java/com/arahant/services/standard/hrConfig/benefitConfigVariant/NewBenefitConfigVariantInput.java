...
public class NewBenefitConfigVariantInput extends TransmitInputBase {

	void setData(BTimeOffAccrualCalc bc)
	{
		bc.setBenefitConfigId(configId);
		bc.setMethod(method);
	...
	@Validation (table="time_off_accrual_calc",column="benefit_config_id", required=true)
	...
	@Validation (min=0, max=100, table="time_off_accrual_calc",column="carry_over_ratio",required=false)
