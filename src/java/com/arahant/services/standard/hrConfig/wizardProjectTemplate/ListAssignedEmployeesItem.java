 ...
 *
 */
public class ListAssignedEmployeesItem {
	...
	public ListAssignedEmployeesItem() {
	}

	ListAssignedEmployeesItem (ProjectTemplateBenefitAssignment ba)
	{
		BPerson emp = new BPerson(ba.getPersonId());
