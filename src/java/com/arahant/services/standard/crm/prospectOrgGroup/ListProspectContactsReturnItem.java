 ...
 *
 */
public class ListProspectContactsReturnItem {
	...
	public ListProspectContactsReturnItem() {
	 ...
	 * @param contact
	 */
	public ListProspectContactsReturnItem(final BProspectContact contact, String groupId) {
		super();
