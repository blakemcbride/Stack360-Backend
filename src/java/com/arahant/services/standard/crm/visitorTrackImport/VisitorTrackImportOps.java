 ...
 * 
 */
package com.arahant.services.standard.crm.visitorTrackImport;
 ...
 *
 */
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardCrmVisitorTrackImportOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class VisitorTrackImportOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(
			VisitorTrackImportOps.class);
	
	public VisitorTrackImportOps() {
		super();
	}
