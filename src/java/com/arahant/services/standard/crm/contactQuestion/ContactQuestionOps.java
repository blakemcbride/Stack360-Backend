...
import com.arahant.reports.ContactQuestionReport;
 ...
 *
 */
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardCrmContactQuestionOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class ContactQuestionOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(
			ContactQuestionOps.class);
	
	public ContactQuestionOps() {
		super();
	}
	...
	public ListQuestionsReturn listQuestions(/*@WebParam(name = "in")*/final ListQuestionsInput in)		
	{
		...
		try
		{
			...
			ret.setItem(BContactQuestion.list(false));
	...
	public SaveQuestionReturn saveQuestion(/*@WebParam(name = "in")*/final SaveQuestionInput in)		
	{
		...
		try
		{
			...
			final BContactQuestion x=new BContactQuestion(in.getId());
			in.setData(x);
			x.update();
	...
	public NewQuestionReturn newQuestion(/*@WebParam(name = "in")*/final NewQuestionInput in)		
	{
		...
		try
		{
			...
			final BContactQuestion x=new BContactQuestion();
			ret.setId(x.create());
			in.setData(x);
			x.insert();
        ...
        public DeleteQuestionsReturn deleteQuestions(/*@WebParam(name = "in")*/final DeleteQuestionsInput in)		
	{
		...
		try
		{
			...
			BContactQuestion.delete(in.getIds());
        ...
        public MoveQuestionReturn moveQuestion(/*@WebParam(name = "in")*/final MoveQuestionInput in)		
	{
		...
		try
		{
			...
			new BContactQuestion(in.getId()).move(in.getMoveUp());
	...
	public GetReportReturn getReport(/*@WebParam(name = "in")*/final GetReportInput in)		
	{
		...
		try
		{
			...
			ret.setReportUrl(new ContactQuestionReport().build());
