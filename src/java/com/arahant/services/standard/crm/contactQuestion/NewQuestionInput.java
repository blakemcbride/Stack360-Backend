...
public class NewQuestionInput extends TransmitInputBase {
	...
	void setData(BContactQuestion bc) {
	...
	@Validation(table = "contact_question", column = "question", required = true)
	private String question;
	@Validation(required = true)
	private String addAfterId;
	@Validation(table = "contact_question", column = "last_active_date", required = false, type = "date")
