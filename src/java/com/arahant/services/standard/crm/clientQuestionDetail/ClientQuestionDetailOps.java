 ...
 *
 */
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardCrmClientQuestionDetailOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class ClientQuestionDetailOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(
			ClientQuestionDetailOps.class);
	
	public ClientQuestionDetailOps() {
		super();
	}
	...
	public GetReportReturn getReport(/*@WebParam(name = "in")*/final GetReportInput in)		
	{
		...
		try
		{
			...
			ret.setReportUrl(new CompanyQuestionDetailReport("Client Detail").build(in.getId()));
