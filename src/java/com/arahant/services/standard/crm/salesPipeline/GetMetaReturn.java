...
public class GetMetaReturn extends TransmitReturnBase {
	 ...
	 */
	public GetMetaReturnItem[] getItem() {
		return item;
	}
	 ...
	 */
	public void setItem(final GetMetaReturnItem[] item) {
		this.item = item;
	}
	...
	void setItem(final BProspectStatus[] a) {
		item=new GetMetaReturnItem[a.length];
		for (int loop=0;loop<a.length;loop++)
			item[loop]=new GetMetaReturnItem(a[loop]);
	}
}
