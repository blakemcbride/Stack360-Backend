...
public class NewClientContactInput extends TransmitInputBase  {
	...
	@Validation (required=false)
	private NewClientContactInputItem []item;

	public NewClientContactInputItem []getItem() {
		if (item==null)
			item=new NewClientContactInputItem[0];
		return item;
	}

	public void setItem(NewClientContactInputItem []item) {
		this.item = item;
	}
