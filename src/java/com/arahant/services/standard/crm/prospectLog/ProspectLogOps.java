...
import com.arahant.reports.ProspectLogReport;
 ...
 *
 */
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardCrmProspectLogOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class ProspectLogOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(
			ProspectLogOps.class);
	
	public ProspectLogOps() {
		super();
	}
	...
	public GetReportReturn getReport(/*@WebParam(name = "in")*/final GetReportInput in)		
	{
		...
		try
		{
			...
			ret.setReportUrl(new ProspectLogReport().build(in.getId()));
