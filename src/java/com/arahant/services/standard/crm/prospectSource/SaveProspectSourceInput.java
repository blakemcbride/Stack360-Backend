 ...
 *
 */
public class SaveProspectSourceInput extends TransmitInputBase {
	...
	private String id;
	@Validation(table = "prospect_source", column = "description", required = true)
	private String description;
	@Validation(table = "prospect_source", column = "source_code", required = true)
	private String code;
	@Validation(table = "prospect_source", column = "last_active_date", required = false, type = "date")
