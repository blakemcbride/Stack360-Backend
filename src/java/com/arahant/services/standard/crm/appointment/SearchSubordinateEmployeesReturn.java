...
public class SearchSubordinateEmployeesReturn extends TransmitReturnBase{
	private SearchSubordinateEmployeesReturnItem [] employees;
	 ...
	 */
	public SearchSubordinateEmployeesReturnItem[] getEmployees() {
		return employees;
	}
	 ...
	 */
	public void setEmployees(final SearchSubordinateEmployeesReturnItem[] employees) {
	...
	void setEmployees(final BEmployee[] e) {
		employees=new SearchSubordinateEmployeesReturnItem[e.length];
		for (int loop=0;loop<e.length;loop++)
			employees[loop]=new SearchSubordinateEmployeesReturnItem(e[loop]);
	}
}
