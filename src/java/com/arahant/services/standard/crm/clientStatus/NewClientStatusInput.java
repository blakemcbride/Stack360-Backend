...
public class NewClientStatusInput extends TransmitInputBase {
	...
	void setData(BClientStatus bc)
	{
		...
		bc.setInitialSequence(initialSequence);
	...
	@Validation (type="date", table="prospect_status",column="last_active_date",required=false)
