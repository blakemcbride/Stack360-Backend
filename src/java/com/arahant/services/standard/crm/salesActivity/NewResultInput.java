 ...
 *
 */
public class NewResultInput extends TransmitInputBase {

	void setData(BSalesActivityResult bc)
	{
		bc.setDescription(description);
		bc.setLastActiveDate(lastActiveDate);
		SalesActivity sa = new BSalesActivity(activityId).getBean();
		bc.setSalesActivity(sa);
		bc.setSequence((short)ArahantSession.getHSU().createCriteria(SalesActivityResult.class).eq(SalesActivityResult.SALES_ACTIVITY, sa).count());
