...
public class SaveTimeEntryInput extends TransmitInputBase {
	...
	private int workDate;  // beginning work date
	...
	/**
	 * @param workDate The beginning workDate to set.
	 */
	...
	public void setEndDate(int endWorkDate) {
		this.endDate = endWorkDate;
	}
	/**
	 * @param bt
	 */
...
//		bt.setProjectId(projectId);
		...
		bt.setPersonId(personId);
		bt.setWorkDate(workDate);
		bt.setEndDate(endDate);
	}
}
