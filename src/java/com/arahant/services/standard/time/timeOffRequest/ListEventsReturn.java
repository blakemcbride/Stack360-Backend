...
public class ListEventsReturn extends TransmitReturnBase {
	 ...
	 */
	public void setItem(final ListEventsReturnItem[] item) {
		this.item = item;
	}
	 ...
	 * @param accounts
	 */
	void setItem(final BEvent[] a, int date) {
		item=new ListEventsReturnItem[a.length];
		for (int loop=0;loop<a.length;loop++)
			item[loop]=new ListEventsReturnItem(a[loop],date);
	}
}
