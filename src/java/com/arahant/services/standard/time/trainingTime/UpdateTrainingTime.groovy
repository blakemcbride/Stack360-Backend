...
class UpdateTrainingTime {
    ...
    static void main(JSONObject inJSON, JSONObject outJSON, HibernateSessionUtil hsu, REST service) {
        String trainingId = inJSON.get('training-id')
        String timesheetId = inJSON.get('timesheet-id')
       ...
       //     throw new ArahantWarning("End time is required.")
        ...
        try {
            ...
            // Update the training detail record.
            BHRTrainingDetail trainingDetail = new BHRTrainingDetail(trainingId)
            ...
            throw new ArahantWarning("Can't insert record.")
        }
    }
}
