...
@WebService(targetNamespace = "http://operations.arahant.com", serviceName = "StandardTimeTimesheetEntryOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED)
@ThreadScope()
public class TimesheetEntryOps extends ServiceBase {

	private static final ArahantLogger logger = new ArahantLogger(TimesheetEntryOps.class);
	...
	public AddTimeEntryReturn addTimeEntry(/*@WebParam(name = "in")*/final AddTimeEntryInput in) {
		...
		try {
			...
			final String benefitId = bemp.newTimeEntry(in.getBeginningTime(),
					...
					in.getProjectId(), in.getShiftId(), in.getTotalHours(), in.getWorkDate(), -1);
	...
	public SaveTimeEntryReturn saveTimeEntry(/*@WebParam(name = "in")*/final SaveTimeEntryInput in) {
		...
		try {
			...
			final String benefitId = bemp.saveTimeEntry(in.getBeginningTime(),
					...
					in.getProjectId(), in.getShiftId(), in.getTotalHours(), in.getWorkDate(), -1, in.getTimesheetId());
            
            BTimesheet bt = new BTimesheet(in.getTimesheetId());
            bt.setTimeTypeId(in.getTimeTypeId());
...
/*
 ...
 PersonEditorService.listSubordinatesObj																																																																																																																																																																																																																																																													
 ...
 TimesheetManagementService.addTimeEntryObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.deleteTimesheetObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.finalizeTimeObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.getNextRejectedDateObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.getPreviousRejectedDateObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.listTimesheetsForPersonOnDateObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.loadTimeEntryObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.markRejectionCorrectedObj																																																																																																																																																																																																																																																													
 TimesheetManagementService.saveTimeEntryObj																																																																																																																																																																																																																																																													
