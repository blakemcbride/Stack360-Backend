 ...
 *
 */
public class SearchSubordinateOrgGroupsInput extends TransmitInputBase {

	@Validation (column="name", table="org_group", required=false)
	private String name;
	...
	public SearchSubordinateOrgGroupsInput() {
		super();
	}
