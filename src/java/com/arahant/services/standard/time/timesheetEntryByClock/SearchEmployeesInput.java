...
public class SearchEmployeesInput extends TransmitInputBase  {
	...
	@Validation (required=false, table="person", column="ssn")
	private String ssn;
	@Validation (required=false, table="person", column="fname")
	private String firstName;
	@Validation (required=false, table="person", column="lname")
	private String lastName;
	@Validation (required=false, min=2, max=5)
