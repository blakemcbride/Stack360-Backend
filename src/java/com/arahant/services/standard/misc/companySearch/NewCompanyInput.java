 ...
 *
 */
public class NewCompanyInput extends TransmitInputBase  {
	...
	public void makeCompany(final BCompany bcc) throws ArahantException {
        ...
        // should default to being an eeo1 establishment
        bcc.setEeo1Establishment(true);
        bcc.setEeo1Headquarters(true);
