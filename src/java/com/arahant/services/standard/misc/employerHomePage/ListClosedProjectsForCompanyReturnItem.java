...
public class ListClosedProjectsForCompanyReturnItem {

	public ListClosedProjectsForCompanyReturnItem()
	{

	}

	ListClosedProjectsForCompanyReturnItem (BProject bp)
	{
		typeCode=bp.getProjectTypeCode();
		summary=bp.getDescription();
		dateTimeRequested=DateUtils.getDateTimeFormatted(bp.getDateCompleted(), bp.getTimeCompleted());
		dateRequested=bp.getDateCompleted();
		timeRequested=bp.getTimeCompleted();
