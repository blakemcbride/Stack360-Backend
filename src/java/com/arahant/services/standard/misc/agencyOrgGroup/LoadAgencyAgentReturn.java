 ...
 *
 */
public class LoadAgencyAgentReturn extends TransmitReturnBase {
    ...
    private LoadAgencyAgentReturnItem[] companies;
    private String cellPhone;
    private String agentExternalRef;
	private String noCompanyScreenGroupId;
	private String noCompanyScreenGroupName;
	private String noCompanyScreenGroupExtId;
     ...
     * @param contact
     */
    void setData(final BAgent contact, final String name) {
        ...
        cellPhone = contact.getMobilePhone();
        agentExternalRef = contact.getExtRef();
		noCompanyScreenGroupId = contact.getNoCompanyScreenGroupId();
		noCompanyScreenGroupName = contact.getNoCompanyScreenGroupName();
	    noCompanyScreenGroupExtId = contact.getNoCompanyScreenGroupExtId();

        BCompany[] comps = contact.getAgentCompanies(contact.getId(), name);

        companies = new LoadAgencyAgentReturnItem[comps.length];
        for (int loop = 0; loop < comps.length; loop++) {
            companies[loop] = new LoadAgencyAgentReturnItem(comps[loop]);
        }
    ...
    public LoadAgencyAgentReturnItem[] getCompanies() {
        return companies;
    }

    public void setCompanies(final LoadAgencyAgentReturnItem[] comps) {
        companies = comps;
    }
	...
	public String getNoCompanyScreenGroupExtId() {
		return noCompanyScreenGroupExtId;
	}

	public void setNoCompanyScreenGroupExtId(String noCompanyScreenGroupExtId) {
		this.noCompanyScreenGroupExtId = noCompanyScreenGroupExtId;
	}

	public String getNoCompanyScreenGroupName() {
		return noCompanyScreenGroupName;
	}

	public void setNoCompanyScreenGroupName(String noCompanyScreenGroupName) {
		this.noCompanyScreenGroupName = noCompanyScreenGroupName;
	}
}
