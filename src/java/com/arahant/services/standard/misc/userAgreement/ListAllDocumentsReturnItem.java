 ...
 *
 */
public class ListAllDocumentsReturnItem {
	
	public ListAllDocumentsReturnItem()
	{
	
	}

	ListAllDocumentsReturnItem (BAgreementForm bc)
	{
		
		name=bc.getName();
		description=bc.getDescription();
		id=bc.getId();
		expirationDate=bc.getExpirationDate();
		expirationDateFormatted=bc.getExpirationDateFormatted();
