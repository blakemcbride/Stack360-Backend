...
public class SearchServicesReturn extends TransmitReturnBase {
	 ...
	 */
	public void setItem(final SearchServicesReturnItem[] item) {
		this.item = item;
	}
	...
	void setItem(final BServiceSubscribed[] a) {
		item=new SearchServicesReturnItem[a.length];
		for (int loop=0;loop<a.length;loop++)
			item[loop]=new SearchServicesReturnItem(a[loop]);
	}
}
