...
public class SearchOrgGroupsGenericReturn extends TransmitReturnBase {
	 ...
	 */
	public FoundOrgGroupsGen[] getOrgGroups() {
		return orgGroups;
	}
	 ...
	 */
	public void setOrgGroups(final FoundOrgGroupsGen[] orgGroups) {
	...
	void setOrgGroups(final BOrgGroup[] groups) {
		orgGroups=new FoundOrgGroupsGen[groups.length];
		for (int loop=0;loop<groups.length;loop++)
			orgGroups[loop]=new FoundOrgGroupsGen(groups[loop]);
	}
}
