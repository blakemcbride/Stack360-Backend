...
public class NewGroupReturn extends TransmitReturnBase  {
	...
	/**
	 * @return Returns the orgGroupTypeName.
	 */
	public String getOrgGroupTypeName() {
		return orgGroupTypeName;
	}
	/**
	 * @param orgGroupTypeName The orgGroupTypeName to set.
	 */
	 ...
	 */
	public int getSuperOrgGroup() {
		return superOrgGroup;
	}
	/**
	 * @param superOrgGroup The superOrgGroup to set.
	 */
	public void setSuperOrgGroup(final int superOrgGroup) {
