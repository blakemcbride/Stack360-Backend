...
public class GetInheritedDefaultProjectReturn extends TransmitReturnBase {
	...
	private String inheritedNewWeekBeginDay = "Unspecified";

	public String getInheritedNewWeekBeginDay() {
		return inheritedNewWeekBeginDay;
	}

	public void setInheritedNewWeekBeginDay(String inheritedNewWeekBeginDay) {
		this.inheritedNewWeekBeginDay = inheritedNewWeekBeginDay;
	}
