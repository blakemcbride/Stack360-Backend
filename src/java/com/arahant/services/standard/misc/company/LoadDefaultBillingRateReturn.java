 ...
 *
 */
public class LoadDefaultBillingRateReturn extends TransmitReturnBase {

	void setData(BCompany bc)
	{
		
		defaultBillingRateFormatted=bc.getDefaultBillingRateFormatted();
