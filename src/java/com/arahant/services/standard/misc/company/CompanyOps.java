...
@WebService(targetNamespace = "http://operations.arahant.com", serviceName = "StandardMiscCompanyOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED)
@ThreadScope()
public class CompanyOps extends ServiceBase {

	static ArahantLogger logger = new ArahantLogger(CompanyOps.class);
	...
	@WebMethod()
	public ListCompanyReturn listCompany(/*
			 * @WebParam(name = "in")
			 */final ListCompanyInput in) {
	...
	@WebMethod()
	public LoadCompanyReturn loadCompany(/*
			 * @WebParam(name = "in")
			 */final LoadCompanyInput in) {
	...
	@WebMethod()
	public NewCompanyReturn newCompany(/*
			 * @WebParam(name = "in")
			 */final NewCompanyInput in) {
	...
	@WebMethod()
	public SaveCompanyReturn saveCompany(/*
			 * @WebParam(name = "in")
			 */final SaveCompanyInput in) {
	...
	@WebMethod()
	public LoadDefaultBillingRateReturn loadDefaultBillingRate(/*
			 * @WebParam(name = "in")
			 */final LoadDefaultBillingRateInput in) {
