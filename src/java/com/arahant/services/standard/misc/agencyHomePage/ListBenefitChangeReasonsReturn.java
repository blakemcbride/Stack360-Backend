...
public class ListBenefitChangeReasonsReturn extends TransmitReturnBase {
	ListBenefitChangeReasonsReturnItem item[];
	 ...
	 */
	public void setItem(final ListBenefitChangeReasonsReturnItem[] item) {
		this.item = item;
	}
	...
	void setItem(final BHRBenefitChangeReason[] a) {
		item=new ListBenefitChangeReasonsReturnItem[a.length];
		for (int loop=0;loop<a.length;loop++)
			item[loop]=new ListBenefitChangeReasonsReturnItem(a[loop]);
	}
}
