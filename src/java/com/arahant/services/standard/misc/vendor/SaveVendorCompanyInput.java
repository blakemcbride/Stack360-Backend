...
import com.arahant.utils.StartupListener;
 ...
 *
 */
public class SaveVendorCompanyInput extends TransmitInputBase {
	
	public SaveVendorCompanyInput()
	{
	 ...
	 */
	void makeCompany(final BVendorCompany v) throws ArahantException {
        ...
        v.setInterfaceId((short)ediInterfaceId);
		v.setDaysToSend(daysToSend);
		v.setTimeToSend(timeToSend);
		v.setEdiActivated(ediActivated);
		v.setEdiFileStatus(ediFileStatus);
		v.setEdiFileType(ediFileType);
		StartupListener.scheduleEdiTimerTask(v, timeToSend, ediActivated.charAt(0));
	}
