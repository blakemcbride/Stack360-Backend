...
public class SearchScreenGroupsReturn extends TransmitReturnBase {
	...
	private FoundScreenGroups [] screenDef;
	 ...
	 */
	public FoundScreenGroups[] getScreenDef() {
		return screenDef;
	}
	 ...
	 */
	public void setScreenDef(final FoundScreenGroups[] screenDef) {
	...
	void setScreenDef(final BScreenOrGroup[] groups) {
		screenDef=new FoundScreenGroups[groups.length];
		for (int loop=0;loop<groups.length;loop++)
			screenDef[loop]=new FoundScreenGroups(groups[loop]);
	}
}
