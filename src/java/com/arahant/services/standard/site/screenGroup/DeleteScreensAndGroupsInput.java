 ...
 *
 */
public class DeleteScreensAndGroupsInput extends TransmitInputBase {
...
@Validation (required=false)
	private boolean deepDelete;
    
	public DeleteScreensAndGroupsInput() {
		super();
	}
