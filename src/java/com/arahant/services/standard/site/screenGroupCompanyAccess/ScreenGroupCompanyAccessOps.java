...
import com.arahant.reports.ScreenGroupCompanyAccessReport;
import com.arahant.services.main.SearchCompaniesInput;
import com.arahant.services.main.SearchCompaniesReturn;
...
@WebService(targetNamespace="http://operations.arahant.com",serviceName="StandardSiteScreenGroupCompanyAccessOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED) 
@ThreadScope()
public class ScreenGroupCompanyAccessOps extends ServiceBase {

	private static final transient ArahantLogger logger = new ArahantLogger(
			ScreenGroupCompanyAccessOps.class);
	
	public ScreenGroupCompanyAccessOps() {
		super();
	}
	...
	public SearchScreenAndSecurityGroupsReturn searchScreenAndSecurityGroups(/*@WebParam(name = "in")*/final SearchScreenAndSecurityGroupsInput in)		
	{
		...
		try
		{
			...
			ret.setItem(BPerson.searchScreenAndSecurityGroups(in.getSearchMetaInput(), in.getFirstName(), in.getLastName(), in.getScreenGroupId(), in.getSecurityGroupId(), in.getCompanyId()));
	...
	public GetReportReturn getReport(/*@WebParam(name = "in")*/final GetReportInput in)		
	{
		...
		try
		{
			...
			ret.setReportUrl(new ScreenGroupCompanyAccessReport().build(in.getFirstName(), in.getLastName(), in.getScreenGroupId(), in.getSecurityGroupId(), in.getCompanyId()));
