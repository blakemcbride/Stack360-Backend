...
import com.arahant.reports.ApplicantAppStatusReport;
...
@WebService(targetNamespace = "http://operations.arahant.com", serviceName = "StandardAtApplicantApplicationStatusOps")
@SOAPBinding(style = Style.DOCUMENT, use = Use.LITERAL, parameterStyle = ParameterStyle.WRAPPED)
@ThreadScope()
public class ApplicantApplicationStatusOps extends ServiceBase {

    private static final transient ArahantLogger logger = new ArahantLogger(ApplicantApplicationStatusOps.class);

    public ApplicantApplicationStatusOps() {
        super();
    }
    ...
    public ListStatusesReturn listStatuses(/*@WebParam(name = "in")*/final ListStatusesInput in) {
        ...
        try {
            ...
            ret.setItem(BApplicationStatus.list(in.getActiveType()));
    ...
    public NewStatusReturn newStatus(/*@WebParam(name = "in")*/final NewStatusInput in) {
        ...
        try {
            ...
            final BApplicationStatus x = new BApplicationStatus();
            ret.setId(x.create());
            in.setData(x);
            x.insert();
    ...
    public SaveStatusReturn saveStatus(/*@WebParam(name = "in")*/final SaveStatusInput in) {
        ...
        try {
            ...
            final BApplicationStatus x = new BApplicationStatus(in.getId());
            in.setData(x);
            x.update();
    ...
    public DeleteStatusesReturn deleteStatuses(/*@WebParam(name = "in")*/final DeleteStatusesInput in) {
        ...
        try {
            ...
            BApplicationStatus.delete(in.getIds());
    ...
    public GetReportReturn getReport(/*@WebParam(name = "in")*/final GetReportInput in) {
        ...
        try {
            ...
            ret.setReportUrl(new ApplicantAppStatusReport().build(in.getActiveType()));
