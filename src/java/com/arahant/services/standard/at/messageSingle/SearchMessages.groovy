...
class SearchMessages {
    ...
    static void main(JSONObject injson, JSONObject outjson, HibernateSessionUtil hsu, REST service) {
        ...
        String applicantId = injson.getString("applicantId")
        ...
        setMessages(outjson, results, applicantId, includeBcc);
    }

    static void setMessages(final JSONObject outjson, final List<Record> mrecs, String applicantId, boolean includeBcc) {
        ...
        for (Record mrec : mrecs) {
            ...
            boolean handled = applicantId == fromPersonId && bm.getFromShow() == (char) 'N'
            ...
            for (Record rec : recs) {
                ...
                if (!handled)
                    handled = applicantId == rec.getString("to_person_id") && rec.getChar("to_show") == (char) 'N'
