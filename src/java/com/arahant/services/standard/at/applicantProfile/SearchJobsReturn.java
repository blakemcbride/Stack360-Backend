 ...
 * Date: 2/4/23
 */
public class SearchJobsReturn extends TransmitReturnBase {

    private SearchJobsReturnItem[] item;
    ...
    public SearchJobsReturnItem[] getItem() {
        return item;
    }

    public void setItem(SearchJobsReturnItem[] items) {
        this.item = items;
    }
