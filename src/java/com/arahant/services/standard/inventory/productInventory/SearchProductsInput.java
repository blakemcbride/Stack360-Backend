...
public class SearchProductsInput extends TransmitInputBase {
	...
	private String selectFromProductInventoryId;
	@Validation (required=false)
	...
	public String getSelectFromProductInventoryId() {
		return selectFromProductInventoryId;
	}

	public void setSelectFromProductInventoryId(String selectFromProductInventoryId) {
		this.selectFromProductInventoryId = selectFromProductInventoryId;
	}
