...
public class SaveLocationCostInput extends TransmitInputBase {

	@Validation (table = "location_cost",column = "location_cost_id",required = true)
	private String locationCostId;
	@Validation (table = "location_cost",column = "description",required = true)
	private String description;
	@Validation (table = "location_cost",column = "location_cost",required = true)
	...
	{
		bc.setLocationCostId(locationCostId);
