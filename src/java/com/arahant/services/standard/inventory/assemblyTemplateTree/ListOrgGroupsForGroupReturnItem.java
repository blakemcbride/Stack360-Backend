 ...
 *
 */
public class ListOrgGroupsForGroupReturnItem {
	
	public ListOrgGroupsForGroupReturnItem()
	{
		
	}

	ListOrgGroupsForGroupReturnItem (BOrgGroup bo)
	{
		
		orgGroupId=bo.getOrgGroupId();
		orgGroupName=bo.getName();
		externalId=bo.getExternalId();
		childCount= bo.getChildCount();
