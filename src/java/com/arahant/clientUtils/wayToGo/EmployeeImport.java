...
public class EmployeeImport extends GenericImport {
	...
	protected void initColumns() {
		...
		addCol(EMPLOYEE_ID, "EmpID", "Employee ID");
	...
	public static void main(String [] argv) {
		try {
			...
			*/
			...
			String reportFile = new EmployeeImport("/home/blake/z/Arahant/Clients/WayToGoStaffing/files/File-03.csv", UPDATE_MODE).parse();
