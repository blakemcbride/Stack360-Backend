...
public class AddressPending extends ArahantBean implements java.io.Serializable {
	...
	private Set<AddressChangeRequest> changeRequests = new HashSet<AddressChangeRequest>();

	@OneToMany
	@JoinColumn(name = "change_record_id")
	public Set<AddressChangeRequest> getChangeRequests() {
		return changeRequests;
	}

	public void setChangeRequests(Set<AddressChangeRequest> changeRequests) {
	...
	/*
	 * (non-Javadoc) @see com.arahant.beans.ArahantBean#generat	@Override eId()
	 */
	@Override
	...
	public boolean equals(Object o) {
		if (addressId == null && o == null)
			return true;
		if (addressId != null && o instanceof AddressPending)
			return addressId.equals(((AddressPending) o).getAddressId());
