...
public class RateTypeReport extends PdfPageEventHelper {

    private Font baseFont;
    private Document document;
    private HibernateSessionUtil hsu;

    public RateTypeReport() {
    ...
    private void writeHeader() throws DocumentException {
        ...
        cell = new PdfPCell(new Paragraph("Billing Rate Type Report", new Font(FontFamily.COURIER, 12F, Font.NORMAL)));
    ...
    private void writeRecords() throws DocumentException {
        PdfPTable table;
        PdfPCell cell;
        boolean alternateRow = true;
        final BaseColor alternateRowColor = new BaseColor(192, 192, 192);
        final HibernateCriteriaUtil hcu = this.hsu.createCriteria(RateType.class).orderBy(RateType.DESCRIPTION);
        final List rateTypes = hcu.list();
        final Iterator iterator = rateTypes.iterator();
        RateType rateType;
        ...
        cell = new PdfPCell(new Paragraph("Billing Rate Type", this.baseFont));
        ...
        while (iterator.hasNext()) {
            rateType = (RateType) iterator.next();

            // toggle the alternate row
            alternateRow = !alternateRow;

            cell = new PdfPCell(new Paragraph(rateType.getDescription(), this.baseFont));
            if (alternateRow)
