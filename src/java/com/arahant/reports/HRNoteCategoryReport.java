 ...
 *
 */
public class HRNoteCategoryReport extends ReportBase {

    public HRNoteCategoryReport() {
    	super("report", "Note Category Report");
    }
	...
	public String build(int activeType) throws DocumentException {
        ...
        try {
            ...
            for (BHRNoteCategory evalCategory : BHRNoteCategory.list(activeType)) {
				 // toggle the alternate row
                alternateRow = !alternateRow;

                write(table, evalCategory.getCatCode(), alternateRow);
