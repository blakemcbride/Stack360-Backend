 ...
 *
 */
public class LocationItemReport extends ReportBase {

    public LocationItemReport() throws ArahantException {
        super("Lot", "Location Products", true);
    }

    public String build(String productId, String orgGroupId, String serialNumber) throws DocumentException {
