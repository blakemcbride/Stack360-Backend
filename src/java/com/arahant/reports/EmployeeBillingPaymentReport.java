 ...
 *
 */
public class EmployeeBillingPaymentReport extends ReportBase {

	
    public EmployeeBillingPaymentReport() throws ArahantException {
        super("report", "Employee Payments", true);
    }
    ...
    public String getReport(int fromDate, int toDate, String personId, String[] ids, boolean excludeZeroBalance) throws DocumentException {
        ...
        try {
			...
			BReceipt []arr=BReceipt.search(fromDate, toDate, personId, excludeZeroBalance, 0);
            ...
            writeColHeader(table, "Un-Applied", Element.ALIGN_RIGHT);
            ...
            for (BReceipt inv : arr) {
               ...
               // toggle the alternate row
				...
				write(table, inv.getType()+"", alternateRow);
                write(table, MoneyUtils.formatMoney(inv.getAmount()), alternateRow);
                write(table, MoneyUtils.formatMoney(inv.getAvailableAmount()), alternateRow);
