...
public class ScreenGroupAccessReport extends ReportBase {

    public ScreenGroupAccessReport() throws ArahantException {
        super("ScrGrpRpt", "Screen Group Access", true);
    }
    ...
    public String build(final String firstName, final String lastName, final String screenGroupId, final String securityGroupId, final String companyId) throws DocumentException {
        ...
        try {
            ...
            table = makeTable(new int[]{18, 3, 18, 3, 18, 3, 25, 3, 25});
    ...
    public static void main(String args[]) {
        try {
			new ScreenGroupAccessReport().build("", "", "", "", ArahantSession.getHSU().getCurrentCompany().getCompanyId());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
