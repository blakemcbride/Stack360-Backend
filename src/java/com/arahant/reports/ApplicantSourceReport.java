 ...
 *
 */
public class ApplicantSourceReport extends ReportBase {

	public ApplicantSourceReport() {
		super("AppLoc", "Applicant Source Report");
	}
	...
	public String build(int activeType) {
		try {
			...
			BApplicantSource[] jobs = BApplicantSource.list(activeType);
			...
			for (BApplicantSource cc : jobs) {
				...
				writeRight(table, DateUtils.getDateFormatted(cc.getInactiveDate()), alternateRow);
