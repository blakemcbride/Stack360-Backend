 ...
 *
 */
public class EmployeeInvoiceReport extends ReportBase {

	
    public EmployeeInvoiceReport() throws ArahantException {
        super("report", "Employee Invoices", true);
    }

    public String build(String []id, int fromDate, int toDate, boolean excludeZeroBalance) throws DocumentException {
        ...
        try {
			...
			BInvoice []arr=BInvoice.searchPersonInvoices(fromDate, toDate, excludeZeroBalance, null, id, 0);
            ...
            for (BInvoice inv : arr) {
               ...
               // toggle the alternate row
                ...
                write(table, DateUtils.getDateCCYYMMDD(inv.getDate()), alternateRow);
